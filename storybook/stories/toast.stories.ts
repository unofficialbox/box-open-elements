...
const toast: StoryModule = {
  ...
  meta: {
    ...
    referenceRows: [
      ...
      { kind: "attribute", name: "borderless", type: "boolean", description: "Drop the outline for a fill-only toast. Geometry is unchanged; the bordered default tracks box-ui-elements." },
  ...
  variants: [
    ...
    { name: "Borderless", html: `<box-toast open borderless heading="Contract executed" message="All parties have signed." tone="success"></box-toast>` },
