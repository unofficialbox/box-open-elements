...
const table: StoryModule = {
  ...
  meta: {
    ...
    referenceRows: [
      ...
      { kind: "attribute", name: "virtualize", type: "boolean", description: "Render only the rows near the viewport; the shell scrolls within --boe-table-height (default 26rem). Ignored when any row declares detail — fixed-height windowing cannot describe expandable rows." },
      ...
      { kind: "property", name: "renderedWindow", type: "RowWindow | null", description: "Read-only: the rendered slice and spacer heights, or null when the render was not windowed." },
