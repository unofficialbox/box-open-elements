...
const menuItem: StoryModule = {
  ...
  meta: {
    ...
    docsDescription: "Use inside custom menu compositions when you are not driving `box-menu` from JSON `items`. The host owns selection and arrow-key navigation; focus(options) moves focus to the inner control without shadow-root access.",
