...
- `packages/react` — release-ready React 19 wrappers (`@unofficialbox/box-open-elements-react`) for `Button`, `TextField`, `Select`, and `Dialog`, plus controller integration. React, Angular, Vue, and Svelte progress is tracked in [docs/integration/framework-adapters.md](./docs/integration/framework-adapters.md).
