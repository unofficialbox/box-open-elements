...
Phases 0–4 of the [roadmap](./docs/roadmap.md) are complete — full catalog parity with the reference repo:
...
- `src/components` — 55 components across all ten categories
