...
export const catalog: CatalogEntry[] = [
  ...
  ...c("Feedback", [
    "alert", "badge", "badgeable", "chip", "due-badge", "empty-state", "error-mask", "help-text", "nudge", "path", "progress-bar", "progress-ring",
    "progress-steps", "skeleton", "spinner", "toast",
  ]),
  ...c("Files", ["drop-zone"]),
  ...c("Output", ["formatted-date", "relative-time", "formatted-number", "formatted-file-size"]),
  ...c("Forms", [
  ...
  ...c("Layout", ["app-shell", "divider", "grid", "nav-sidebar", "section", "sidebar-toggle-button", "split-view"]),
  ...
  { id: "compare-view", tier: "patterns", category: "Diff", tag: "box-compare-view" },
