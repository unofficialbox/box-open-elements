...
export const catalog: CatalogEntry[] = [
  ...
  ...c("Feedback", [
    "alert", "badge", "empty-state", "help-text", "progress-bar", "progress-ring",
    "progress-steps", "skeleton", "spinner", "toast",
  ]),
  ...c("Files", ["drop-zone"]),
  ...c("Forms", [
    "checkbox", "checkbox-group", "color-picker", "combobox", "date-field", "dropdown",
    ...
    "text-area", "text-field", "time-field",
  ]),
  ...c("Identity", ["avatar", "persona"]),
  ...c("Layout", ["app-shell", "split-view"]),
  ...
  ...p("Share", ["share-panel", "permission-matrix"]),
