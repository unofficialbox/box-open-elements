...
- Brand imagery: product-illustration contract documented from shipped registry/`box-illustration` assets in `docs/foundations/brand.md`. **Still open:** direct review of the Box brand-style-guide Imagery Figma frame (file URL + access not in-repo; do not invent photography/marketing art direction).
